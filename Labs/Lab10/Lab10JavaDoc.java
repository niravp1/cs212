...
public class Lab10JavaDoc {
  ...
  /**
   *Fills cells of matrix with integers starting at 0 
   * @param m matrix to fill
   * @param v value to assign to each cell
   */ 
   ...
   /**
    * Returns sum of all values stored in matrix
   ...
   /**
    * Sums the cells  of all cells in matrix
